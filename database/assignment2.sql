-- Query 1: Insert new record to the account table
...
FROM public.classification AS cls
    INNER JOIN public.inventory AS inv ON inv.classification_id = cls.classification_id
