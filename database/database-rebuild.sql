...
ALTER TABLE IF EXISTS public.classification OWNER to cse340db;
...
CREATE TABLE public.inventory (
    ...
    CONSTRAINT classification_id FOREIGN KEY (classification_id) REFERENCES public.classification (classification_id) MATCH SIMPLE ON UPDATE CASCADE ON DELETE NO ACTION NOT VALID
);
ALTER TABLE IF EXISTS public.inventory OWNER to cse340db;
